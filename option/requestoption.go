...
// RequestOption is an option for the requests made by the bannerify API Client
// which can be supplied to clients, services, and methods. You can read more about this functional
// options pattern in our [README].
//
// [README]: https://pkg.go.dev/github.com/stainless-sdks/bannerify-go#readme-requestoptions
...
func WithEnvironmentProduction() RequestOption {
	return WithBaseURL("https://api.bannerify.co/")
}
...
func WithAPIKey(value string) RequestOption {
	return func(r *requestconfig.RequestConfig) error {
		r.APIKey = value
		return r.Apply(WithQuery("apiKey", r.APIKey))
	}
}
