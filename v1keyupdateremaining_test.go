...
func TestV1KeyUpdateRemainingNew(t *testing.T) {
	...
	_, err := client.V1.Keys.UpdateRemaining.New(context.TODO(), tempbannerify.V1KeyUpdateRemainingNewParams{
		KeyID: tempbannerify.F("key_123"),
		Op:    tempbannerify.F(tempbannerify.V1KeyUpdateRemainingNewParamsOpIncrement),
		Value: tempbannerify.F(int64(1)),
	})
	if err != nil {
