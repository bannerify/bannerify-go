...
func TestV1APICreateAPINew(t *testing.T) {
	...
	_, err := client.V1.APIs.CreateAPI.New(context.TODO(), tempbannerify.V1APICreateAPINewParams{
		Name: tempbannerify.F("my-api"),
	})
	if err != nil {
