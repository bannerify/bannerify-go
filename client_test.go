...
func TestUserAgentHeader(t *testing.T) {
	...
	client.V1.Liveness(context.Background())
...
func TestRetryAfter(t *testing.T) {
	...
	res, err := client.V1.Liveness(context.Background())
	if err == nil || res != nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	res, err := client.V1.Liveness(cancelCtx)
	if err == nil || res != nil {
		t.Error("Expected there to be a cancel error and for the response to be nil")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		res, err := client.V1.Liveness(deadlineCtx)
		if err == nil || res != nil {
